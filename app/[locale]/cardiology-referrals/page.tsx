...
import CardiologyReferralsPage from "@/app/cardiology-referrals/page";
...
export async function generateMetadata({ params }: LocalePageProps) {
  ...
  return createLocalizedPageMetadata(
    ...
    localizePath("/cardiology-referrals", getRouteLocale(params?.locale)),
  );
}

export default function LocalizedCardiologyReferralsPage({
  params,
}: LocalePageProps) {
  if (!isSupportedLocale(getRouteLocale(params?.locale))) {
    notFound();
  ...
  return <CardiologyReferralsPage />;
}
